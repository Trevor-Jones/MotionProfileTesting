...
public class Spline {
  ...
  public static boolean reticulateSplines(double x0, double y0, double theta0,
    ...
    double theta0_hat = MathUtil.getDifferenceInAngleRadians(
            result.theta_offset_, theta0);
    double theta1_hat = MathUtil.getDifferenceInAngleRadians(
    ...
    if (Math.abs(MathUtil.getDifferenceInAngleRadians(theta0_hat,
            theta1_hat))
            >= Math.PI / 2) {
      return false;
    }
